...
describe('Trinket model', function(){
    ...
    describe('createHash', function() {
      ...
      it('should generate a hash and shortcode based on code, lang, owner and parent', function(done) {
        ...
        Trinket.hooks.pre.save.createHash.call(trinket, function() {
          ...
          // R-6: production `hashify` takes .substring(0, 12) - see docs/PRESERVED-QUIRKS.md section 13.7.
  ...
  describe('class methods', function() {
    ...
    // R-6: model.js#findById calls findOne(query) with a single argument and adapts a promise,
    // unlike findByHash above - see docs/PRESERVED-QUIRKS.md section 13.7.
    ...
    describe('findByIdAndUpdateMetrics', function() {
      ...
      before(function(done) {
        // R-6: production calls findByIdAndUpdate(id, update, options) and awaits a promise, and
        // interaction.save() takes no arguments - see docs/PRESERVED-QUIRKS.md section 13.7.
