  ...
  create : async function(request, h) {
    ...
    try {
      ...
      if (err.code === 11000) {
        ...
        // reproduced - the raise still happens here, and its measured effect is answered with
        // `h.abandon`. The second, process-level half - nothing in app.js, config/
      ...
      // which no branch in this file does - and it is NOT a 500. It is reproduced as measured with
      // `h.abandon`; see lib/http/responseContract.js.
      return h.abandon;
    }
