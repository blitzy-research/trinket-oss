...
var USAGE = [
  ...
  '                       session cookie is served Secure. In THIS pass the',
  '                       second onPreResponse appends the Expires horizon and',
  '                       then "; SameSite=None; Secure", so the serialised',
  '                       value carries SameSite TWICE - Lax from the state',
  '                       definition and None from the append, which is the',
  '                       occurrence a browser resolves. That is the base',
  '                       commit\'s behaviour, byte for byte (app.js:372',
  '                       against baseline app.js:229), and it is what the',
  '                       delivered corpora record. An earlier revision of this',
  '                       text said SameSite stays Lax in both passes, citing',
  '                       approved deviation 7; that deviation has been',
  '                       WITHDRAWN (docs/preserved-quirks.md §11.11) and the',
  '                       duplication is preserved.',
