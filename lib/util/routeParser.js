// Eleven of the thirteen bindings below are unused in this file, deliberately. Nine went unused when
// the shim's behavior moved into lib/http/*, which is where their consumers - and so the bindings
// themselves - now live; crypto and HAS_EXT were already unused at the base commit. R-1 sanctions only
// the dependency inventory's own removals, which for this file were tab and optimist, so the rest stay.
// Adjudication, with the census and the citations: docs/PRESERVED-QUIRKS.md section 3.46.
