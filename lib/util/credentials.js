 ...
 *
 * Across the 24 models exactly two schema fields have a normalized name matching an entry:
 * `User.password`, which is the intended target, and `CourseInvitation.token` - a genuinely
 * client-visible value, the invitation link's own key - which is a TOP-LEVEL string in its own
